...
import 'package:jinya_app/network/errors/MissingApiKeyException.dart';
import 'package:jinya_app/network/errors/MissingFieldException.dart';
import 'package:jinya_app/network/errors/NotEnoughPermissionsException.dart';
import 'package:jinya_app/network/errors/NotFoundException.dart';
...
Future<JinyaResponse> post(
  ...
  final response = await http.post(
    '${SettingsDatabase.selectedAccount.url}/$path',
    headers: {
...
Future<JinyaResponse> get(String path) async {
  final response =
      await http.get('${SettingsDatabase.selectedAccount.url}/$path', headers: {
    HttpHeaders.contentTypeHeader: 'application/json',
    'JinyaApiKey': SettingsDatabase.selectedAccount.apiKey,
    'JinyaDeviceCode': SettingsDatabase.selectedAccount.deviceToken,
  });
...
Future<int> head(String path) async {
  final response = await http
      .head('${SettingsDatabase.selectedAccount.url}/$path', headers: {
    HttpHeaders.contentTypeHeader: 'application/json',
    'JinyaApiKey': SettingsDatabase.selectedAccount.apiKey,
    'JinyaDeviceCode': SettingsDatabase.selectedAccount.deviceToken,
  });
